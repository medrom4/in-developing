function showMessage() {
	...
	var otvet = a.reduce(function (x, y) {
		return x + y
	}, 0);
	...
	console.log(otvet + ', ' + product + ', ' + max + ', ' + min);
}
...
//every() - ответ true, если переданная вами функция- предикат вернула true для всех элементов массива
//some() - true, если в массиве имеется хотя бы один элемент, для которого функция- предикат вернет true
//reduce() - объединяют элементы массива, используя указанную вами функцию, и возвращают единственное значение
//educeRight() - тоже самое, только в обратном порядке
//
//
//
//
